...
return function(object,tri_list,a,b,c,n,fs)
    ...
    if v1z < 0 then
        if v2z < 0 then
            n = n + 1
            clip_2(object,n,tri_list,a,b,c,fs)
        elseif v3z < 0 then
            n = n + 1
            clip_2(object,n,tri_list,a,c,b,fs)
        else
            n = n + 2
            clip_1(object,n,tri_list,a,b,c,fs)
        end
    elseif v2z < 0 then
        if v3z < 0 then
            n = n + 1
            clip_2(object,n,tri_list,b,c,a,fs)
        else
            n = n + 2
            clip_1(object,n,tri_list,b,a,c,fs)
        end
    elseif v3z < 0 then
        n = n + 2
        clip_1(object,n,tri_list,c,a,b,fs)
    else
        n = n + 1
        tri_list[n] = {a,b,c,fs=fs,object=object}
    end
    return n
end