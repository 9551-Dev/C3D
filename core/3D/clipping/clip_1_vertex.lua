...
return function(object,n,tris,v1,v2,v3,fs,index)
    ...
    tris[n-1] = {v10,v2,v3,split=true,fs=fs,object=object,index=index}
    tris[n] = {v3,v01,v10,split=true, fs=fs,object=object,index=index}
end